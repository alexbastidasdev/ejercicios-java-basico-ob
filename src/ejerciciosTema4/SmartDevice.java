...
public class SmartDevice {
    ...
    public static class SmartPhone extends SmartDevice {
        ...
        public String toString() {
            return "marca=" + marca + ", modelo=" + modelo + ", color=" + color + ", ram=" + ram + ", sistema=" + sistema;
        }
    }
    ...
    public static class SmartWatch extends SmartDevice {
        ...
        @Override
        public String toString() {
            return "marca=" + marca + ", modelo=" + modelo + ", color=" + color + ", pulgadas=" + pulgadas + ", conectividad=" + conectividad;
        }
    }
